...
nulgrind:tsan1/$(EXE)
	@echo "        ------Nulgrind------"
	-$(PRECMD)\
	$(DATA_RACE_DETECTION_ROOT)/thread-sanitizer/install/bin/valgrind --trace-children=yes --read-var-info=yes --log-file=$@.log --suppressions=$(DATA_RACE_DETECTION_ROOT)/thread-sanitizer/libc.supp --tool=none ./tsan1/$(EXE) $(ARGS)\
	$(POSTCMD)
	@grep "ERROR SUMMARY" $@.log
parrot-tsan1:$(PARROT)
